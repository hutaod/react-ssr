...
module.exports = function () {
  let devHost = '//localhost:8002'

  let jsFiles = ['thirds.js', 'main.js']
  ...
  if (!__IS_PROD__) {
    ...
    // )
    assets.js.push(
      `<script type="text/javascript" crossorigin src="${devHost}/main.js"></script>`
    )
    assets.css.push(
      `<link rel="stylesheet" type="text/css" crossorigin href="${devHost}/main.css" />`
    )
  } else {
